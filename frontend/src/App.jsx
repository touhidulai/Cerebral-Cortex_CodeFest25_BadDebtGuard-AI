...
function App() {
  ...
  const translations = {
    en: {
      ...
      approved: 'Approved',
      aiAnalysisAccuracy: 'AI Analysis Accuracy',
      avgProcessingTime: 'Avg Processing Time',
      recentAssessments: 'Recent Assessments',
      creditScore: 'Credit Score',
      newLoanAssessment: 'New Loan Assessment',
      configureParams: 'Configure assessment parameters and upload required documents',
      selectBankingSystem: 'Select Banking System',
      conventionalBanking: 'Conventional Banking',
      ...
      supportedFormats: 'Supported: PDF, DOCX, TXT, Images (PNG, JPG)',
      uploadedFiles: 'Uploaded Files',
      delete: 'Delete',
      startAnalysis: 'Start AI-Powered Analysis',
      analyzing: 'Analyzing',
      riskAnalysis: 'Risk Analysis',
      riskLevel: 'Risk Level',
      riskPremium: 'Risk Premium',
      defaultProbability: 'Default Probability',
      creditStability: 'Credit Stability Score',
      ...
      baseRate: 'Base Rate',
      creditRiskPremium: 'Credit Risk Premium',
      ltvAdjustment: 'LTV Adjustment',
      employmentDiscount: 'Employment Discount',
      incomeDiscount: 'Income Discount',
      creditHistoryDiscount: 'Credit History Discount',
    ...
    ms: {
      appTitle: 'LoanAI Pro',
      appSubtitle: 'Platform Penilaian Pinjaman Pintar',
      dashboard: 'Papan Pemuka',
      newAssessment: 'Penilaian Baharu',
      history: 'Sejarah',
      applicationsThisMonth: 'Permohonan Bulan Ini',
      approved: 'Diluluskan',
      aiAnalysisAccuracy: 'Ketepatan Analisis AI',
      avgProcessingTime: 'Purata Masa Pemprosesan',
      recentAssessments: 'Penilaian Terkini',
      creditScore: 'Skor Kredit',
      newLoanAssessment: 'Penilaian Pinjaman Baharu',
      configureParams: 'Konfigurasi parameter penilaian dan muat naik dokumen yang diperlukan',
      selectBankingSystem: 'Pilih Sistem Perbankan',
      conventionalBanking: 'Perbankan Konvensional',
      islamicBanking: 'Perbankan Islam',
      loanType: 'Jenis Pinjaman',
      financingType: 'Jenis Pembiayaan',
      customerType: 'Jenis Pelanggan',
      uploadDocuments: 'Muat Naik Dokumen',
      dragAndDrop: 'Seret dan lepas fail di sini, atau klik untuk melayari',
      supportedFormats: 'Disokong: PDF, DOCX, TXT, Imej (PNG, JPG)',
      uploadedFiles: 'Fail yang Dimuat Naik',
      delete: 'Padam',
      startAnalysis: 'Mulakan Analisis Berkuasa AI',
      analyzing: 'Menganalisis',
      riskAnalysis: 'Analisis Risiko',
      riskLevel: 'Tahap Risiko',
      riskPremium: 'Premium Risiko',
      defaultProbability: 'Kebarangkalian Mungkir',
      creditStability: 'Skor Kestabilan Kredit',
      repaymentCapacity: 'Kapasiti Pembayaran Balik',
      aiConfidence: 'Keyakinan AI',
      executiveSummary: 'Ringkasan Eksekutif',
      keyFindings: 'Penemuan Utama',
      calculationBreakdown: 'Pecahan Pengiraan',
      baseRate: 'Kadar Asas',
      creditRiskPremium: 'Premium Risiko Kredit',
      ltvAdjustment: 'Pelarasan LTV',
      employmentDiscount: 'Diskaun Pekerjaan',
      incomeDiscount: 'Diskaun Pendapatan',
      creditHistoryDiscount: 'Diskaun Sejarah Kredit',
      totalRate: 'Jumlah Kadar',
      confidenceMetrics: 'Metrik Keyakinan',
      documentAuthenticity: 'Ketulenan Dokumen',
      incomeStability: 'Kestabilan Pendapatan',
      defaultRisk: 'Risiko Mungkir',
      overallRecommendation: 'Cadangan Keseluruhan',
      recommendation: 'Cadangan',
      approvedAmount: 'Jumlah Diluluskan',
      maxTenure: 'Tempoh Maksimum',
      indicativeRate: 'Kadar Indikatif',
      documentsAnalyzed: 'Dokumen Dianalisis',
      homeLoan: 'Pinjaman Rumah',
      homeFinancing: 'Pembiayaan Rumah',
      carLoan: 'Pinjaman Kereta',
      carFinancing: 'Pembiayaan Kereta',
      personalLoan: 'Pinjaman Peribadi',
      personalFinancing: 'Pembiayaan Peribadi',
      businessLoan: 'Pinjaman Perniagaan',
      businessFinancing: 'Pembiayaan Perniagaan',
      salariedEmployee: 'Pekerja Bergaji',
      rentalIncome: 'Pendapatan Sewa',
      smallBusinessOwner: 'Pemilik Perniagaan Kecil',
      largeEnterprise: 'Perusahaan Besar',
  ...
  const bankingSystems = [
    { id: 'conventional', name: language === 'en' ? 'Conventional Banking' : 'Perbankan Konvensional', icon: Building2 },
    { id: 'islamic', name: language === 'en' ? 'Islamic Banking' : 'Perbankan Islam', icon: Shield }
  ];
  ...
  const customerTypes = [
    { id: 'salaried', name: language === 'en' ? 'Salaried Employee' : 'Pekerja Bergaji', requirements: ['Payslips (3 months)', 'EPF statement', 'Employment letter'] },
    { id: 'rental', name: language === 'en' ? 'Rental Income' : 'Pendapatan Sewa', requirements: ['Tenancy agreements', 'Rental income statements', 'Property ownership proof'] },
    { id: 'small-business', name: language === 'en' ? 'Small Business Owner' : 'Pemilik Perniagaan Kecil', requirements: ['Business financial statements', 'SSM registration', 'Bank statements (6 months)'] },
    { id: 'large-business', name: language === 'en' ? 'Large Enterprise' : 'Perusahaan Besar', requirements: ['Audited financial statements', 'Company registration', 'Board resolution'] }
  ];
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <button 
              ...
              style={{
                ...
                background: language === 'en' ? '#4f46e5' : 'white',
                color: language === 'en' ? 'white' : '#4f46e5',
                fontWeight: '600',
                cursor: 'pointer',
      ...
      <div className="main-content">
          ...
          <div className="dashboard-content">
            ...
            <div className="stats-grid">
              <div className="stat-card">
                ...
                <p className="stat-label">{t.applicationsThisMonth}</p>
              </div>
              <div className="stat-card">
                <div className="stat-header">
              ...
              <div className="stat-card">
                ...
                <p className="stat-label">{t.aiAnalysisAccuracy}</p>
              </div>
              <div className="stat-card">
                <div className="stat-header">
                ...
                <h3 className="stat-value">3.2 {t.days}</h3>
            ...
            {/* Recent Assessments */}
            <div className="card">
              <h2 className="card-title">{t.recentAssessments}</h2>
                  ...
                  <div key={assessment.id} className="assessment-item">
                    ...
                    <div className="assessment-details">
                      <div className="score-info">
                        ...
                        <p className="score-label">{t.creditScore}</p>
                      </div>
                      <span className={`status-badge ${assessment.status}`}>
                        {t[assessment.status] || assessment.status.charAt(0).toUpperCase() + assessment.status.slice(1)}
                      </span>
        ...
        {activeTab === 'assessment' && (
          <div className="assessment-content">
            <div className="card">
              <h2 className="section-title">{t.newLoanAssessment}</h2>
              <p className="section-subtitle">{t.configureParams}</p>

              {/* Step 1: Banking System Selection */}
              <div className="step-section">
                <h3 className="step-title">
                  <span className="step-number">1</span>
                  {t.selectBankingSystem}
                </h3>
              ...
              <div className="step-section">
                <h3 className="step-title">
                  ...
                  {selectedBankingSystem === 'islamic' ? t.financingType : t.loanType}
                </h3>
                ...
                <div className="step-section">
                  ...
                  <div className="upload-zone">
                    ...
                    <label htmlFor="file-upload" className="upload-label">
                      ...
                      <p className="upload-title">{t.dragAndDrop}</p>
                  ...
                  {uploadedDocs.length > 0 && (
                    <div className="uploaded-docs">
                      <h4 className="uploaded-title">{t.uploadedFiles} ({uploadedDocs.length})</h4>
                        ...
                        <div className="results-content">
                            ...
                            <div className="risk-assessment-container">
                                ...
                                <div className={`risk-metric-card ${riskClass}`}>
                                    ...
                                    <span className="metric-subtitle">{language === 'en' ? 'AI-Enhanced Classification' : 'Klasifikasi Dipertingkat AI'}</span>
                                    </div>
                                ...
                                <div className={`risk-metric-card ${riskClass}`}>
                                    <div className="metric-header">
                                    <span className="metric-label">{t.riskPremium}</span>
                                    ...
                                    <span className="metric-subtitle">{language === 'en' ? 'AI-Calculated Premium' : 'Premium Dikira AI'}</span>
                                    </div>
                                ...
                                <div className="indicator-item">
                                    ...
                                    <span className="indicator-label">{t.defaultProbability}</span>
                                ...
                                <div className="indicator-item">
                                    ...
                                    <div className="indicator-content">
                                    <span className="indicator-label">{t.creditStability}</span>
                                ...
                                <div className="indicator-item">
                                    ...
                                    <div className="indicator-content">
                                    <span className="indicator-label">{t.repaymentCapacity}</span>
                                ...
                                <div className="indicator-item">
                                    ...
                                    <div className="indicator-content">
                                    <span className="indicator-label">{t.aiConfidence}</span>
                            ...
                            <div className="reasoning-container">
                                ...
                                {language === 'en' ? 'AI Analysis Reasoning & Document Insights' : 'Penaakulan Analisis AI & Pandangan Dokumen'}
                                </h3>
                                
                                <div className="reasoning-content">
                                <div className="summary-section">
                                    <h4 className="summary-title">{t.executiveSummary}</h4>
                                ...
                                <div className="findings-section">
                                    <h4 className="findings-title">{t.keyFindings}</h4>
                                ...
                                <div className="confidence-section">
                                    <h4 className="confidence-title">{t.confidenceMetrics}</h4>
                                    <div className="confidence-bars">
                                    <div className="confidence-bar-item">
                                        <div className="confidence-label-row">
                                        <span className="confidence-label">{t.documentAuthenticity}</span>
                                    ...
                                    <div className="confidence-bar-item">
                                        <div className="confidence-label-row">
                                        <span className="confidence-label">{t.incomeStability}</span>
                                    ...
                                    <div className="confidence-bar-item">
                                        <div className="confidence-label-row">
                                        <span className="confidence-label">{t.defaultRisk}</span>
                                    ...
                                    <div className="confidence-bar-item">
                                        <div className="confidence-label-row">
                                        <span className="confidence-label">{t.overallRecommendation}</span>
                            ...
                            <div className="recommendation-card">
                                ...
                                <CheckCircle className="icon-md" />
                                <h4 className="recommendation-title">{t.recommendation}</h4>
                                </div>
